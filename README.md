...
https://doi.org/10.5281/zenodo.19163202
# GRA Forum App
...
**GRA Forum App** is a playground application that uses the [gra-forum](https://github.com/qqewq/gra-forum) library to solve software engineering tasks through multi-agent debate with foam minimization. It implements a **Software Engineering Task Runner** where four specialized AI agents collaborate to design, implement, and verify software components.
